...
The ecological unit relevant to information burden is therefore not necessarily the species, habitat type or environmental state. It is the **decision-equivalence class** generated by the focal interaction.
...
The relevant temporal variable is therefore not persistence alone but **persistence of decision-relevant heterogeneity**.
